...
Blockly.JavaScript['button_pullup_new'] = function (block) {
  var dropdown_pin_ = block.getFieldValue('pin_');
...
Blockly.JavaScript['AM2320_new'] = function (block) {
  // var variable_AM2320_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('AM2320'), Blockly.Variables.NAME_TYPE)
  var code = 'getAM2320(board)';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};


Blockly.JavaScript['AM2320_get'] = function (block) {
  var variable_var_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('var_'), Blockly.Variables.NAME_TYPE);
  var value_time = Blockly.JavaScript.valueToCode(block, 'time', Blockly.JavaScript.ORDER_ATOMIC);
  var statements_do = Blockly.JavaScript.statementToCode(block, 'do');
  var code = variable_var_ + '.read(async function(evt){\n' +
...
Blockly.JavaScript['AM2320_get_number'] = function (block) {
  var variable_name_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('name_'), Blockly.Variables.NAME_TYPE);
  var dropdown_AM2320_ = block.getFieldValue('AM2320_');
  var code = variable_name_ + '.' + dropdown_AM2320_;
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

//---------------------------------FDS100---------------------------------------//

Blockly.JavaScript['FDS100_new'] = function (block) {
    // var variable_AM2320_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('AM2320'), Blockly.Variables.NAME_TYPE)
    var code = 'getFDS100(board)';
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
};


Blockly.JavaScript['FDS100_get'] = function (block) {
    var variable_var_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('var_'), Blockly.Variables.NAME_TYPE);
    var value_time = Blockly.JavaScript.valueToCode(block, 'time', Blockly.JavaScript.ORDER_ATOMIC);
    var statements_do = Blockly.JavaScript.statementToCode(block, 'do');
    var code = variable_var_ + '.read(async function(evt){\n' +
...
Blockly.JavaScript['FDS100_get_number'] = function (block) {
    var variable_name_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('name_'), Blockly.Variables.NAME_TYPE);
    var dropdown_FDS100_ = block.getFieldValue('FDS100_');
    var code = variable_name_ + '.' + dropdown_FDS100_;
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

//-----------------------------IRCount---------------------------------------//

Blockly.JavaScript['IRCount_new'] = function (block) {
  var dropdown_pin0_ = block.getFieldValue('pin0_');
  var dropdown_pin1_ = block.getFieldValue('pin1_');
  var dropdown_pin2_ = block.getFieldValue('pin2_');
  var code = 'getIRCount(board, ' + dropdown_pin0_  + ', ' + dropdown_pin1_ + ', ' + dropdown_pin2_ + ')';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};


Blockly.JavaScript['IRCount_get'] = function (block) {
  var variable_var_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('var_'), Blockly.Variables.NAME_TYPE);
  var value_time = Blockly.JavaScript.valueToCode(block, 'time', Blockly.JavaScript.ORDER_ATOMIC);
  var statements_do = Blockly.JavaScript.statementToCode(block, 'do');
  var code = variable_var_ + '.read(async function(evt){\n' +
...
Blockly.JavaScript['IRCount_get_number'] = function (block) {
  var variable_name_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('name_'), Blockly.Variables.NAME_TYPE);
  var dropdown_IRCount_ = block.getFieldValue('IRCount_');
  var code = variable_name_ + '.' + dropdown_IRCount_;
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

Blockly.JavaScript['IRCount_stopRead'] = function (block) {
  var variable_name_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('name_'), Blockly.Variables.NAME_TYPE);
...
Blockly.JavaScript['BME280_new'] = function (block) {
  var code = 'getBME280(board)';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};


Blockly.JavaScript['BME280_get'] = function (block) {
  var variable_var_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('var_'), Blockly.Variables.NAME_TYPE);
  var value_time = Blockly.JavaScript.valueToCode(block, 'time', Blockly.JavaScript.ORDER_ATOMIC);
  var statements_do = Blockly.JavaScript.statementToCode(block, 'do');
  var code = variable_var_ + '.read(async function(evt){\n' +
...
Blockly.JavaScript['BME280_get_number'] = function (block) {
  var variable_name_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('name_'), Blockly.Variables.NAME_TYPE);
  var dropdown_BME280_ = block.getFieldValue('BME280_');
  var code = variable_name_ + '.' + dropdown_BME280_;
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

//---------------------------UVsensor---------------------------------------//

Blockly.JavaScript['UVsensor_new'] = function (block) {
  var code = 'getUVsensor(board)';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};


Blockly.JavaScript['UVsensor_get'] = function (block) {
  var variable_var_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('var_'), Blockly.Variables.NAME_TYPE);
  var value_time = Blockly.JavaScript.valueToCode(block, 'time', Blockly.JavaScript.ORDER_ATOMIC);
  var statements_do = Blockly.JavaScript.statementToCode(block, 'do');
  var code = variable_var_ + '.read(async function(evt){\n' +
...
Blockly.JavaScript['UVsensor_get_number'] = function (block) {
  var variable_name_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('name_'), Blockly.Variables.NAME_TYPE);
  var dropdown_UVsensor_ = block.getFieldValue('UVsensor_');
  var code = variable_name_ + '.' + dropdown_UVsensor_;
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

//---------------------------Rain---------------------------------------//

Blockly.JavaScript['Rain_new'] = function (block) {
  var code = 'getRain(board)';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};


Blockly.JavaScript['Rain_get'] = function (block) {
  var variable_var_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('var_'), Blockly.Variables.NAME_TYPE);
  var value_time = Blockly.JavaScript.valueToCode(block, 'time', Blockly.JavaScript.ORDER_ATOMIC);
  var statements_do = Blockly.JavaScript.statementToCode(block, 'do');
  var code = variable_var_ + '.read(async function(evt){\n' +
...
Blockly.JavaScript['Rain_get_number'] = function (block) {
  var variable_name_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('name_'), Blockly.Variables.NAME_TYPE);
  var dropdown_Rain_ = block.getFieldValue('Rain_');
  var code = variable_name_ + '.' + dropdown_Rain_;
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

//---------------------------Wind---------------------------------------//

Blockly.JavaScript['Wind_new'] = function (block) {
  var code = 'getWind(board)';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};


Blockly.JavaScript['Wind_get'] = function (block) {
  var variable_var_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('var_'), Blockly.Variables.NAME_TYPE);
  var value_time = Blockly.JavaScript.valueToCode(block, 'time', Blockly.JavaScript.ORDER_ATOMIC);
  var statements_do = Blockly.JavaScript.statementToCode(block, 'do');
  var code = variable_var_ + '.read(async function(evt){\n' +
...
Blockly.JavaScript['Wind_get_number'] = function (block) {
  var variable_name_ = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('name_'), Blockly.Variables.NAME_TYPE);
  var dropdown_Wind_ = block.getFieldValue('Wind_');
  var code = variable_name_ + '.' + dropdown_Wind_;
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};
//------------------------------------------------------------------------//
...
Blockly.JavaScript['lcd1602_new'] = function(block) {
  ...
  // var code = variable_lcd + ' = getLCD1602(board);\n';
  // return code;
};
Blockly.JavaScript['lcd1602_print'] = function(block) {
  var variable_name = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('LCD'), Blockly.Variables.NAME_TYPE);
  var value_value_ = Blockly.JavaScript.valueToCode(block, 'value_', Blockly.JavaScript.ORDER_ATOMIC);
  var code = variable_name + '.print('+value_value_+');\n';
  return code;
};

Blockly.JavaScript['LoRa_new'] = function (block) {
  var code = 'getLoRa(board)';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

Blockly.JavaScript['LoRa_print'] = function(block) {
  var variable_name = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('LoRa'), Blockly.Variables.NAME_TYPE);
  var dropdown_freq_ = block.getFieldValue('freq_');
  var value_value_ = Blockly.JavaScript.valueToCode(block, 'value_', Blockly.JavaScript.ORDER_ATOMIC);
  var code = variable_name + '.send('+dropdown_freq_+',String('+value_value_+'));\n';
  return code;
};
